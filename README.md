...
1. [**Modifying the app files to allow Prometheus collecting metrics.**](https://github.com/otam-mato/nodejs_elk/blob/main/README.md#modify-the-app-files-to-employ-bunyan-for-logging)
